...
type Config struct {
	...
	// NoPKCS11BIP32 Disables BIP32 Key Derivation for HD HSM Wallet
	NoPKCS11BIP32 bool `toml:",omitempty"`
...
func makeAccountManager(conf *Config) (*accounts.Manager, string, error) {
	...
	if pkcs11Lib != "" {
		...
		if hsm, err := hsmwallet.NewHsmBackend(pkcs11Lib, !conf.NoPKCS11BIP32); err != nil {
